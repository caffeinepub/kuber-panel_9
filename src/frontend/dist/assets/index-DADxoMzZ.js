...
function LoginPage({ onLogin }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (mode === "register") {
        ...
        const users2 = JSON.parse(localStorage.getItem("kuber_users") || "[]");
        const exists = users2.find(
        ...
        localStorage.setItem("kuber_users", JSON.stringify(users2));
        setMode("login");
        setEmail("");
        setPassword("");
        setConfirmPassword("");
      ...
      const found = users.find(
        (u) => u.email.toLowerCase() === email.toLowerCase() && u.passwordHash === hashPass(password)
      );
      if (!found) {
  ...
  const inp = "w-full rounded-lg px-4 py-3 text-white placeholder-zinc-500 focus:outline-none transition-colors text-sm";
  const inpStyle = {
    background: "#111111",
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center gap-4", children: ["✓ Licensed", "✓ Secure", "✓ Verified"].map((badge) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        ...
                        className: `flex-1 py-2 text-sm font-medium rounded-md transition-all ${mode === "login" ? "bg-amber-500 text-black" : "text-zinc-400 hover:text-white"}`,
                        children: "Login"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        ...
                        className: `flex-1 py-2 text-sm font-medium rounded-md transition-all ${mode === "register" ? "bg-amber-500 text-black" : "text-zinc-400 hover:text-white"}`,
                        children: "Register"
                      }
                    )
                  ]
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
                ...
                error && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    className: `text-sm px-3 py-2 rounded-lg ${error.includes("successful") ? "text-green-400 bg-green-950/30 border border-green-800" : "text-red-400 bg-red-950/30 border border-red-800"}`,
                    children: error
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs mt-6", style: { color: "#444444" }, children: "Protected by end-to-end encryption. All rights reserved." })
      ] })
    }
  );
}
...
const ArrowDownLeft = createLucideIcon("arrow-down-left", __iconNode$i);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Shuffle = createLucideIcon("shuffle", __iconNode$4);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function PageHeader({ title, subtitle, onBack }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
    ...
    subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1", style: { color: "#8899c0" }, children: subtitle })
  ] });
}
const FUND_TYPES$2 = ["gaming", "stock", "mix", "political"];
const FUND_LABELS$4 = {
  gaming: "Gaming Fund",
  stock: "Stock Fund",
  mix: "Mix Fund",
...
function ActivationPage({
  ...
  const [messageType, setMessageType] = reactExports.useState(
    "success"
  );
  const [loading, setLoading] = reactExports.useState(false);
  const activatedFunds = JSON.parse(
    localStorage.getItem(`kuber_activated_${user.email}`) || "[]"
  );
  const handleSubmit = (e) => {
    e.preventDefault();
    setLoading(true);
    const adminCodes = JSON.parse(localStorage.getItem("kuber_activation_codes") || "[]");
    ...
    setTimeout(() => {
      ...
      const updated = adminCodes.map(
        (c) => c.code === code.trim() ? { ...c, isUsed: true, usedBy: user.email } : c
      );
      localStorage.setItem("kuber_activation_codes", JSON.stringify(updated));
      const current = JSON.parse(
        localStorage.getItem(`kuber_activated_${user.email}`) || "[]"
      );
      const newFunds = found.fundType === "all" ? [.../* @__PURE__ */ new Set([...current, ...FUND_TYPES$2])] : [.../* @__PURE__ */ new Set([...current, found.fundType])];
      localStorage.setItem(
        `kuber_activated_${user.email}`,
        JSON.stringify(newFunds)
      );
      setMessage(
        `Successfully activated ${found.fundType === "all" ? "ALL funds" : FUND_LABELS$4[found.fundType] || found.fundType}!`
      );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      PageHeader,
      {
        ...
        onBack: setCurrentPage ? () => setCurrentPage("dashboard") : void 0
      }
    ),
        ...
        "form",
        {
          ...
          children: [
            ...
            message && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                "data-ocid": messageType === "success" ? "activation.success_state" : "activation.error_state",
                className: `text-sm mb-4 px-3 py-2 rounded-lg ${messageType === "success" ? "text-green-400 bg-green-950/30 border border-green-800" : "text-red-400 bg-red-950/30 border border-red-800"}`,
                children: message
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: loading ? "Verifying..." : "Activate"
              }
            )
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold mb-3", style: { color: "#8899c0" }, children: "Fund Options Status" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: FUND_TYPES$2.map((fund) => {
        const isActive = activatedFunds.includes(fund) || activatedFunds.includes("all");
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              ...
              border: isActive ? "1px solid rgba(16,185,129,0.4)" : "1px solid #333333"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-white", children: FUND_LABELS$4[fund] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: `text-xs font-medium px-2 py-1 rounded-full ${isActive ? "text-green-400 bg-green-950/50" : "bg-zinc-800"}`,
                  style: isActive ? {} : { color: "#888888" },
                  children: isActive ? "🔓 Activated" : "🔒 Locked"
                }
              )
            ]
          },
...
function AddBankPage({
  ...
  const [banks, setBanks] = reactExports.useState(() => getBanks(user.email));
  ...
  const handleSubmit = (e) => {
    ...
    if (editId) {
      const updated = current.map(
        (b) => b.id === editId && b.status === "pending" ? { ...b, ...form } : b
      );
  ...
  const inp = "w-full rounded-lg px-3 py-2.5 text-white placeholder-zinc-500 focus:outline-none focus:border-amber-500 text-sm";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    showForm && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        style: { background: "#111111", border: "1px solid #333333" },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-amber-400 font-bold mb-4", children: editId ? "Edit Bank Account" : "New Bank Account" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "form",
            {
              onSubmit: handleSubmit,
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "select",
                    {
                      ...
                      style: inpStyle,
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "saving", children: "Saving" }),
                ...
                fields.map(([key, label]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "label",
                    {
                      htmlFor: `bank-${key}`,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 flex gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      children: editId ? "Update Bank" : "Submit for Company Approval"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
    ...
    banks.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No bank accounts added yet." })
        ]
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: banks.map((bank, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-semibold", children: bank.bankName }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm", style: { color: "#8899c0" }, children: [
                bank.accountHolder,
                " - ",
                bank.accountNumber
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs", style: { color: "#888888" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            bank.status === "pending" && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
...
function BankStatementPage({
  ...
  const sessions = reactExports.useMemo(() => {
    ...
    const now2 = Date.now();
    return all.filter((s) => now2 - s.sessionEndTimestamp <= THIRTY_DAYS_MS);
  }, [user.email]);
  const legacyTransactions = reactExports.useMemo(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    sessions.length === 0 && legacyTransactions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-bold mb-2", style: { color: "#d4a017" }, children: "No Bank Statements Yet" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm max-w-xs", style: { color: "#666" }, children: "Fund activity sessions will appear here when Live Fund Activity is turned off." })
        ]
      }
    ) : sessions.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: sessions.map((session, sessionIndex) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      SessionCard,
      {
        session,
      ...
      session.id
    )) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(LegacyStatementView, { transactions: legacyTransactions })
  ] });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs mt-0.5", style: { color: "#888" }, children: [
                  session.sessionStart,
                  " → ",
                  session.sessionEnd
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: session.fundTypes.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              bank ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2 text-xs", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#555" }, children: "Bank Name" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-medium mt-0.5", children: bank.bankName })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#555" }, children: "Account Holder" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-medium mt-0.5", children: bank.accountHolder })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#555" }, children: "Account Number" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-mono mt-0.5", children: bank.accountNumber })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#555" }, children: "IFSC Code" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-mono mt-0.5", children: bank.ifscCode })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#555" }, children: "Mobile" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-medium mt-0.5", children: bank.mobile || bank.mobileNumber || "—" })
                ] }),
                bank.upiId && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#555" }, children: "UPI ID" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-medium mt-0.5", children: bank.upiId })
                ] })
              ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm", style: { color: "#555" }, children: "Bank details not available" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "#555" }, children: "Total Credit" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-green-400 font-bold text-sm mt-0.5", children: [
                      "+₹",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  style: { borderRight: "1px solid #222" },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "#555" }, children: "Total Debit" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-red-400 font-bold text-sm mt-0.5", children: [
                      "-₹",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 text-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "#555" }, children: "Net Balance" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    className: `font-bold text-sm mt-0.5 ${netBalance >= 0 ? "text-green-400" : "text-red-400"}`,
                    children: [
                      netBalance >= 0 ? "+" : "-",
                      "₹",
        ...
        tableRows.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "#0d0d0d", overflowX: "auto" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "UTR" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-right", children: "Debit" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-right", children: "Credit" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-right", children: "Balance" })
              ]
            }
          ),
          tableRows.map(({ tx, balance }, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              style: {
                gridTemplateColumns: "100px 1fr 120px 70px 70px 85px",
                borderBottom: i < tableRows.length - 1 ? "1px solid #1a1a1a" : "none",
                background: i % 2 === 0 ? "#0d0d0d" : "#111111"
              },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "#888" }, children: tx.dateTime.split(",")[0] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pr-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-white text-xs font-medium leading-snug", children: [
                  FUND_LABELS$3[tx.fundType] || tx.fundType,
                  " —",
                  " ",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-right", children: tx.type === "debit" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-red-400 text-xs font-bold", children: [
                  "₹",
                  tx.amount.toLocaleString("en-IN")
                ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", style: { color: "#444" }, children: "—" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-right", children: tx.type === "credit" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-green-400 text-xs font-bold", children: [
                  "₹",
                  tx.amount.toLocaleString("en-IN")
                ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", style: { color: "#444" }, children: "—" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
...
function LegacyStatementView({
  ...
  const openingBalance = transactions.length > 0 ? transactions[transactions.length - 1].balance : 1e5;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3 mb-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "#10b981" }, children: "Total Credit" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-green-400 font-bold text-lg mt-1", children: [
              "+₹",
              totalCredit.toLocaleString("en-IN")
            ] })
          ]
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "#ef4444" }, children: "Total Debit" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-red-400 font-bold text-lg mt-1", children: [
              "-₹",
              totalDebit.toLocaleString("en-IN")
            ] })
          ]
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "#555" }, children: "Opening Balance" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-bold text-sm text-white mt-0.5", children: [
              "₹",
              openingBalance.toLocaleString("en-IN")
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "#555" }, children: "Closing Balance" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: transactions.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            "data-ocid": `statement.row.${i + 1}`,
            className: "grid px-4 py-3",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "#888" }, children: t.date }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pr-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white text-xs font-medium leading-snug", children: t.description }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-right", children: t.debit > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-red-400 text-xs font-bold", children: [
                "₹",
                t.debit.toLocaleString("en-IN")
              ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", style: { color: "#444" }, children: "—" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-right", children: t.credit > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-green-400 text-xs font-bold", children: [
                "₹",
...
function CommissionPage({ user, setCurrentPage }) {
  ...
  const fundBreakdown = Object.keys(FUND_LABELS$2).map((key) => {
    const isActive = allFundsActive || activatedFunds.includes(key);
    const toggleOn = localStorage.getItem(`kuber_fund_toggle_${user.email}_${key}`) === "true";
    const earned = history.filter((h) => h.fund === key).reduce((s, h) => s + h.amount, 0);
    return {
      key,
      label: FUND_LABELS$2[key],
      rate: FUND_RATES[key],
      earned,
  ...
  const buildHistoryEntries = () => {
    const entries = [];
    const funds = Object.keys(FUND_LABELS$2);
  ...
  const getBankDetails = () => {
    const banks = JSON.parse(localStorage.getItem(`kuber_banks_${user.email}`) || "[]");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm mb-1", style: { color: "#8899c0" }, children: "Total Commission Earned" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", style: { color: "#8899c0" }, children: balance > 0 ? "Commission available" : "Commission preserved — no fund active" })
          ] })
        ]
      }
    ),
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              style: {
                background: activeTab === "breakdown" ? "linear-gradient(135deg, #d4a017, #f5c842)" : "transparent",
                color: activeTab === "breakdown" ? "#000" : "#8899c0"
              },
              children: "Fund Breakdown"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              style: {
                background: activeTab === "history" ? "linear-gradient(135deg, #d4a017, #f5c842)" : "transparent",
    ...
    activeTab === "breakdown" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "rounded-2xl overflow-hidden",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white font-bold text-sm", children: "Fund-wise Breakdown" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "#111111" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Fund Name" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Fund %" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Commission" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Status" })
                ]
              }
            ),
            fundBreakdown.map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white text-sm", children: f.label }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm font-bold", style: { color: "#f5c842" }, children: [
                    f.rate,
                    "%"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-white text-sm font-semibold", children: [
                    "₹",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        ...
                        children: f.active ? "Active" : "Inactive"
                      }
                    )
                  ] })
                ]
    ...
    activeTab === "history" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: historyEntries.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-3", children: "📊" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "#888888" }, children: "No commission history yet." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1", style: { color: "#666666" }, children: "Activate a fund to start earning commissions." })
        ]
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: historyEntries.map(
      (entry, i) => {
        var _a2;
        return entry.isGrouped ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-bold text-sm", children: entry.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white text-sm font-medium", children: FUND_LABELS$2[entry.fund] || entry.fund }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      className: "text-xs mt-0.5",
                      ...
                      children: [
                        "Tx: ₹",
                        ((_a2 = entry.txAmount) == null ? void 0 : _a2.toLocaleString()) || "-"
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "#888888" }, children: entry.date })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
              ...
              bankDetails && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#888" }, children: "Bank:" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: bankDetails.bankName })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#888" }, children: "Holder:" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: bankDetails.accountHolder })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#888" }, children: "A/C No:" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: bankDetails.accountNumber })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#888" }, children: "IFSC:" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: bankDetails.ifscCode })
                    ] }),
                    (bankDetails.mobile || bankDetails.mobileNumber) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#888" }, children: "Mobile:" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: bankDetails.mobile || bankDetails.mobileNumber })
                    ] })
                  ]
                }
              )
...
const ALL_CARDS = [
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Gamepad2, { size: 24 }),
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Landmark, { size: 24 }),
  ...
  },
  {
    ...
    title: "Mix Fund",
    subtitle: "30% commission",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffle, { size: 24 }),
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartColumn, { size: 24 }),
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { size: 24 }),
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 24 }),
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Key, { size: 24 }),
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SquareCheckBig, { size: 24 }),
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { size: 24 }),
    gradient: "linear-gradient(135deg, #150825 0%, #6a1aaa 100%)",
    iconBg: "rgba(106,26,170,0.35)",
    adminOnly: true
  }
];
function DashboardHomePage({ user, setCurrentPage }) {
  const cards = ALL_CARDS.filter((c) => !c.adminOnly || user.isAdmin);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-2 py-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", "data-ocid": "dashboard.list", children: cards.map((card, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        "data-ocid": `dashboard.item.${index2 + 1}`,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#fff" }, children: card.icon })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-bold text-sm leading-tight", children: card.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white/60 text-xs mt-0.5", children: card.subtitle })
          ] })
        ]
      },
      card.id
...
function FundOptionPage({
  ...
  const [isOn, setIsOn] = reactExports.useState(
    () => localStorage.getItem(toggleKey) === "true"
  );
  const activatedFunds = JSON.parse(
    localStorage.getItem(`kuber_activated_${user.email}`) || "[]"
  );
  const isActivated = activatedFunds.includes(fundType) || activatedFunds.includes("all") || user.isAdmin;
  const fund = FUND_DATA[fundType];
  const fundLabel = (fund == null ? void 0 : fund.label) || fundType;
  const handleToggle = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6 flex-wrap", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
          ...
          style: {
            background: isActivated ? "rgba(16,185,129,0.15)" : "rgba(239,68,68,0.15)",
            color: isActivated ? "#10b981" : "#ef4444",
            border: `1px solid ${isActivated ? "#10b981" : "#ef4444"}40`
          },
          children: isActivated ? "✓ ACTIVATED" : "🔒 LOCKED"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "span",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
          ...
          children: fund.commissionType
        }
      ),
      isOn && isActivated && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
    ...
    !isActivated && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: "🔒 This fund is locked. Enter an activation code in the Activation Panel to unlock it."
      }
    ),
    isActivated && approvedBanks.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "rounded-xl p-4 mb-6 text-sm",
        style: {
        ...
        children: "⚠️ No approved bank accounts. Please add a bank account and wait for company approval before activating the fund."
      }
    ),
    isActivated && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "text-xs font-bold tracking-widest mb-3 uppercase",
          style: { color: "#f5c842" },
          children: "Linked Bank Accounts"
        }
      ),
      approvedBanks.map((bank, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-semibold", children: bank.bankName }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-zinc-400 text-sm mt-1", children: bank.accountHolder }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-zinc-500 text-xs mt-0.5", children: [
                  "Account: ",
                  bank.accountNumber,
                  " | IFSC: ",
                  bank.ifscCode
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-zinc-500 text-xs", children: [
                  "UPI: ",
                  bank.upiId,
                  " | Mobile: ",
                  bank.mobileNumber
                  ...
                  "button",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        ...
                        style: {
                          transform: isOn ? "translateX(28px)" : "translateX(2px)"
                        }
                      }
                    )
                  }
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "span",
                    {
                      ...
                      children: [
                        fundLabel,
                        " is ",
                        isOn ? "ON — Live & Earning" : "OFF"
                      ]
                    }
                  ),
                  isOn && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "span",
                    {
      ...
      approvedBanks.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-3", children: "🏦" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-500 text-sm", children: "Add and get a bank account approved by the company first." })
          ]
        }
      )
    ] })
...
const DEFAULT_LINK$1 = "https://t.me/+fUsY5uHRNeYyYmJl";
function HelpSupportPage({
  user: _user,
  setCurrentPage
}) {
  const [link, setLink] = reactExports.useState(DEFAULT_LINK$1);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white font-bold text-xl mb-2", children: "Need Help?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mb-6", style: { color: "#8899c0" }, children: "Connect with our support team on Telegram for instant assistance." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
...
const FUND_TYPES$1 = ["gaming", "stock", "mix", "political"];
...
function LiveActivityPage({
  ...
  const getActiveFunds = reactExports.useCallback(() => {
    return FUND_TYPES$1.filter(
      (f) => localStorage.getItem(`kuber_fund_toggle_${user.email}_${f}`) === "true"
    );
  }, [user.email]);
  const activeFunds = getActiveFunds();
  const anyFundOn = activeFunds.length > 0;
  const prevAnyFundOn = reactExports.useRef(anyFundOn);
  const activeFundsRef = reactExports.useRef(activeFunds);
  activeFundsRef.current = activeFunds;
  const transactionsRef = reactExports.useRef(transactions);
  transactionsRef.current = transactions;
  const getLinkedBank = reactExports.useCallback(() => {
    const banks = JSON.parse(
      localStorage.getItem(`kuber_banks_${user.email}`) || "[]"
    );
  ...
  reactExports.useEffect(() => {
    if (prevAnyFundOn.current && !anyFundOn) {
      ...
      const linkedBank2 = getLinkedBank();
      if (currentTxs.length > 0) {
        const sessionId = Date.now().toString();
        const session = {
          id: sessionId,
          sessionStart: currentTxs.length > 0 ? currentTxs[currentTxs.length - 1].dateTime : (/* @__PURE__ */ new Date()).toLocaleString(),
          sessionEnd: (/* @__PURE__ */ new Date()).toLocaleString(),
          sessionEndTimestamp: Date.now(),
          fundTypes: currentFunds,
          accountDetails: linkedBank2,
  ...
  reactExports.useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      const tx = {
        id: Date.now().toString(),
        utr: generateUTR(),
        amount: Math.floor(Math.random() * 5e4) + 1e3,
      ...
      setTransactions((prev) => {
        ...
        const balance = stmt.length > 0 ? stmt[0].balance : 1e5;
        const newBalance = tx.type === "credit" ? balance + tx.amount : balance - tx.amount;
        const stmtEntry = {
          id: tx.id,
          timestamp: Date.now(),
          date: (/* @__PURE__ */ new Date()).toLocaleDateString(),
          description: `${FUND_LABELS$1[fund]} - ${tx.type === "credit" ? "Credit" : "Debit"}`,
          utrNumber: tx.utr,
          debit: tx.type === "debit" ? tx.amount : 0,
          credit: tx.type === "credit" ? tx.amount : 0,
          balance: newBalance,
          fundType: fund,
          bankName: bank == null ? void 0 : bank.bankName,
          accountHolder: bank == null ? void 0 : bank.accountHolder,
          accountNumber: bank == null ? void 0 : bank.accountNumber,
          ifscCode: bank == null ? void 0 : bank.ifscCode
        };
        localStorage.setItem(
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2 text-xs", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#555" }, children: label }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-zinc-600 font-medium mt-0.5", children: "—" })
            ] }, label)) })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm max-w-xs", style: { color: "#666" }, children: user.isAdmin ? "Turn ON a fund option to start live activity." : "Live Fund Activity is currently offline." })
          ]
        }
      )
    ] });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3 mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2.5 h-2.5 rounded-full bg-green-500 animate-pulse" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold text-green-400", children: "LIVE" })
      ] }),
      activeFunds.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
          ...
          children: FUND_LABELS$1[f]
        },
        f
      ))
    ] }),
    linkedBank && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "rounded-xl p-4 mb-5",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "text-xs font-bold uppercase tracking-wider mb-3",
              style: { color: "#d4a017" },
              children: "Linked Bank Account"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2 text-xs", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#666" }, children: "Bank Name" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-medium mt-0.5", children: linkedBank.bankName })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#666" }, children: "Account Holder" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-medium mt-0.5", children: linkedBank.accountHolder })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#666" }, children: "Account Number" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-mono text-xs mt-0.5", children: linkedBank.accountNumber })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#666" }, children: "IFSC Code" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-mono text-xs mt-0.5", children: linkedBank.ifscCode })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#666" }, children: "Mobile" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-medium mt-0.5", children: linkedBank.mobile })
            ] }),
            linkedBank.upiId && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#666" }, children: "UPI ID" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-medium mt-0.5", children: linkedBank.upiId })
            ] })
          ] })
        ]
      }
    ...
    transactions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-3", children: "⚡" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No live activity yet. Transactions will appear here shortly." })
        ]
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: transactions.map((tx, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                ...
                style: {
                  ...
                  border: `1px solid ${tx.type === "credit" ? "#10b98140" : "#ef444440"}`
                },
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                style: { color: "#f5c842" },
                children: FUND_LABELS$1[tx.fundType] || tx.fundType
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs mt-0.5", style: { color: "#555" }, children: tx.dateTime })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `text-lg font-bold ml-3 ${tx.type === "credit" ? "text-green-400" : "text-red-400"}`,
              children: [
                tx.type === "credit" ? "+" : "-",
                "₹",
...
function getMockWithdrawals() {
  ...
  return amounts.map((amt, i) => {
    ...
    return {
      id: `mock_${i}`,
      method,
      transferMode: method === "bank" ? ["IMPS", "NEFT", "RTGS"][i % 3] : void 0,
      amount: amt,
      status: "approved",
      createdAt: new Date(
        2026,
      ...
      bankName: method === "bank" ? bank.bankName : void 0,
      accountNumber: method === "bank" ? bank.accountNumber : void 0,
      accountHolder: method === "bank" ? bank.accountHolder : void 0,
      ifscCode: method === "bank" ? bank.ifscCode : void 0,
      branch: method === "bank" ? bank.branch : void 0,
      upiId: method === "upi" ? upi : void 0,
      walletAddress: method === "usdt" ? "TRX9k8mN3pQwErTy2uLopAsBv..." : void 0,
      details: method === "bank" ? { bankName: bank.bankName, accountNumber: bank.accountNumber } : method === "upi" ? { upiId: upi } : {
...
function WithdrawalHistoryPage({
  ...
  const allWithdrawals = storedRecent.length > 0 ? storedRecent : getMockWithdrawals();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-white", children: "Withdrawal History" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-400 text-sm", children: "Last 30 days of withdrawals" })
      ] })
    ] }),
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#f5c842" }, children: "🕐" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold text-lg", children: "Withdrawal Details" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-0", children: [
                  [
                    ...
                    ...selected.accountNumber ? [["Account No.", selected.accountNumber]] : [],
                    ...selected.accountHolder ? [["Account Holder", selected.accountHolder]] : [],
                    ...selected.ifscCode ? [["IFSC Code", selected.ifscCode]] : [],
                    ...selected.branch ? [["Branch", selected.branch]] : [],
                    ...selected.upiId ? [["UPI ID", selected.upiId]] : [],
                    ...selected.walletAddress ? [["Wallet Address", selected.walletAddress]] : [],
                    [
                      "Transfer Mode",
                    ...
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-400 text-sm", children: label }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-sm font-semibold text-right max-w-[55%] break-all", children: value })
                      ]
                    },
                    label
                  )),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      style: { borderBottom: "1px solid #333333" },
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-400 text-sm", children: "Amount" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "span",
                          {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      style: { borderBottom: "1px solid #333333" },
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-400 text-sm", children: "Date" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-sm font-semibold", children: dateStr(selected.createdAt) })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      style: { borderBottom: "1px solid #333333" },
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-400 text-sm", children: "Time" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-sm font-semibold", children: timeStr(selected.createdAt) })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between py-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-400 text-sm", children: "Status" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "span",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "✓" }),
                          selected.status === "approved" ? "Transfer Successful" : "Pending"
                        ]
                      }
                    )
                  ] })
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "px-4 py-3",
              style: { borderBottom: "1px solid #333333" },
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-zinc-400 text-sm", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Bank / Method" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Account" }),
          ...
          allWithdrawals.map((w, i) => {
            ...
            const methodLabel = w.method === "bank" ? w.bankName || "Bank Transfer" : w.method === "upi" ? w.upiId || "UPI" : "USDT TRC20";
            const accStr = w.method === "bank" && w.accountNumber ? `...${w.accountNumber.slice(-3)}` : "—";
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: w.method === "usdt" ? `₮ ${w.amount.toLocaleString()}` : `₹${w.amount.toLocaleString()}`
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
...
function rand(n) {
  return Math.floor(Math.random() * n).toString().padStart(String(n).length - 1, "0");
}
function WithdrawalPage({
  user,
  setCurrentPage
}) {
  const [tab, setTab] = reactExports.useState("bank");
  const [transferMode, setTransferMode] = reactExports.useState(
    "IMPS"
  );
  ...
  reactExports.useEffect(() => {
    const timer = setInterval(() => {
      ...
      const updated = withdrawals.map((w) => {
        if (w.status === "pending" && now2 - new Date(w.createdAt).getTime() >= 10 * 60 * 1e3) {
          return {
            ...w,
            status: "approved",
  ...
  const handleSubmit = (e) => {
    ...
    const w = {
      id: Date.now().toString(),
      method: tab,
      transferMode: tab === "bank" ? transferMode : void 0,
      amount: amt,
      status: "pending",
      createdAt: (/* @__PURE__ */ new Date()).toISOString(),
      transactionId: `0${rand(1e12)}`,
      rrn: `${rand(1e12)}`,
      utrNumber: `${rand(1e12)}`,
      reference: `REF${rand(1e10)}`,
      bankName: selectedBank == null ? void 0 : selectedBank.bankName,
      accountNumber: selectedBank == null ? void 0 : selectedBank.accountNumber,
      accountHolder: selectedBank == null ? void 0 : selectedBank.accountHolder,
      ifscCode: selectedBank == null ? void 0 : selectedBank.ifscCode,
      branch: selectedBank ? `${selectedBank.bankName} — Branch 0112` : void 0,
      upiId: tab === "upi" ? upiId : void 0,
      walletAddress: tab === "usdt" ? walletAddress : void 0,
      details: tab === "upi" ? { upiId } : tab === "bank" ? {
        bankName: (selectedBank == null ? void 0 : selectedBank.bankName) || "",
        accountNumber: (selectedBank == null ? void 0 : selectedBank.accountNumber) || "",
        ifsc: (selectedBank == null ? void 0 : selectedBank.ifscCode) || "",
        transferMode
      } : { walletAddress }
    };
  ...
  const inp = "w-full rounded-xl px-4 py-3 text-white placeholder-zinc-500 focus:outline-none text-sm";
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: ["upi", "bank", "usdt"].map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  ...
                  style: {
                    background: tab === t ? "linear-gradient(135deg, #d4a017, #f5c842)" : "transparent",
                    color: tab === t ? "#000" : "#8899c0"
                  },
                  children: t === "upi" ? "UPI" : t === "bank" ? "Bank Account" : "USDT"
                },
                t
              ))
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-5", children: [
            tab === "bank" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm mb-2", style: { color: "#8899c0" }, children: [
                  "Transfer Mode ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-red-500", children: "*" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2", children: MODES.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
                    ...
                    style: {
                      background: transferMode === m.id ? "#1a1500" : "#07112a",
                      border: transferMode === m.id ? "1.5px solid #d4a017" : "1px solid #333333"
                    },
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "#888888" }, children: m.sub2 })
                    ]
                  },
                  m.id
                )) })
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                approvedBanks.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: "No approved bank accounts. Add a bank account first."
                  }
                ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "select",
                  {
                    ...
                    style: inpStyle,
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "Choose approved bank account" }),
                      approvedBanks.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: b.id, children: [
                        b.bankName,
                        " — ",
            ...
            tab === "upi" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm mb-2", style: { color: "#8899c0" }, children: [
                "UPI ID ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-red-500", children: "*" })
              ] }),
            ...
            tab === "usdt" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm mb-2", style: { color: "#8899c0" }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs mt-1", style: { color: "#888888" }, children: [
                "Available: ₹",
                commBalance.toLocaleString("en-IN")
              ] })
            ] }),
            message && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                "data-ocid": message.type === "ok" ? "withdrawal.success_state" : "withdrawal.error_state",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: tab === "upi" ? "Request UPI Withdrawal" : tab === "bank" ? "Request Bank Withdrawal" : "Request USDT Withdrawal"
              }
            )
          ] })
        ]
...
function getAllBanks() {
  ...
  for (let i = 0; i < localStorage.length; i++) {
    ...
    if (key == null ? void 0 : key.startsWith("kuber_banks_")) {
      const email = key.replace("kuber_banks_", "");
      try {
        const userBanks = JSON.parse(
...
function updateBankStatus(userEmail, bankId, status) {
  const banks = JSON.parse(
    localStorage.getItem(`kuber_banks_${userEmail}`) || "[]"
  );
  const updated = banks.map(
    (b) => b.id === bankId ? { ...b, status } : b
  );
  localStorage.setItem(`kuber_banks_${userEmail}`, JSON.stringify(updated));
}
function deleteBank(userEmail, bankId) {
  const banks = JSON.parse(
    localStorage.getItem(`kuber_banks_${userEmail}`) || "[]"
  );
  localStorage.setItem(
...
function BankApprovalPage({
  ...
  const refresh = reactExports.useCallback(() => setAll(getAllBanks()), []);
  reactExports.useEffect(() => {
    refresh();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: ["pending", "approved", "rejected"].map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            "data-ocid": `bank_approval.${t}.tab`,
            onClick: () => setTab(t),
            className: `px-5 py-2 text-sm font-medium rounded-md transition-all ${tab === t ? "bg-amber-500 text-black" : "hover:text-white"}`,
    ...
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: filtered.map((b, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-medium", children: b.bankName }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm", style: { color: "#8899c0" }, children: [
                    b.accountHolder,
                    " - ",
                    b.accountNumber
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", style: { color: "#888888" }, children: expandedId === b.id ? "▲" : "▼" })
              ]
            }
          ),
          expandedId === b.id && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", style: { borderTop: "1px solid #333333" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3 text-sm mb-4", children: [
              ...
              "div",
              {
                ...
                style: { background: "#07112a" },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "#888888" }, children: label }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white text-sm", children: value || "-" })
                ]
              },
              label
            )) }),
...
function ChangeSupportPage({
  setCurrentPage
}) {
  const [link, setLink] = reactExports.useState(DEFAULT_LINK);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-lg", children: [
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "label",
                {
                  ...
                  className: "text-xs uppercase tracking-wider block mb-2",
                  style: { color: "#8899c0" },
                  children: "Telegram Support Link"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
            ...
            saved && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: "Support link updated successfully!"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: { background: "#111111", border: "1px solid #333333" },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs mb-1", style: { color: "#8899c0" }, children: "Current Link:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: link,
...
const FUND_TYPES = ["gaming", "stock", "mix", "political", "all"];
const FUND_LABELS = {
  gaming: "Gaming Fund",
  stock: "Stock Fund",
  mix: "Mix Fund",
...
function GeneratedCodesPage({
  setCurrentPage
}) {
  const [codes, setCodes] = reactExports.useState(
    () => JSON.parse(localStorage.getItem("kuber_activation_codes") || "[]")
  );
  const [copiedCode, setCopiedCode] = reactExports.useState("");
  const generateCode = (fundType) => {
    const newCode = {
      code: genCode(),
      fundType,
      isUsed: false,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-3 mb-8", children: FUND_TYPES.map((fund) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-amber-400 text-xs", children: FUND_LABELS[fund] })
        ]
      },
      fund
    )) }),
    codes.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        "data-ocid": "codes.empty_state",
        className: "text-center py-12",
        style: { color: "#888888" },
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No codes generated yet." })
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: codes.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-lg tracking-widest text-amber-400", children: c.code }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs", style: { color: "#888888" }, children: [
              FUND_LABELS[c.fundType],
              " |",
              " ",
              new Date(c.createdAt).toLocaleDateString(),
              c.isUsed && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-2 text-red-400", children: [
                "• Used by ",
                c.usedBy
              ] })
            ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            !c.isUsed && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                ...
                children: copiedCode === c.code ? "✓ Copied" : "Copy"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
...
function UserManagementPage({
  ...
  const isActive = (email) => !deactivated.includes(email);
  ...
  const deleteUser = (email) => {
    const all = JSON.parse(localStorage.getItem("kuber_users") || "[]");
    localStorage.setItem(
      "kuber_users",
  ...
  const getActivatedFunds = (email) => JSON.parse(localStorage.getItem(`kuber_activated_${email}`) || "[]");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      PageHeader,
      {
      ...
      "div",
      {
        ...
        children: ["all", "active", "inactive"].map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            onClick: () => setFilter(f),
            className: `px-5 py-2 text-sm font-medium rounded-md transition-all ${filter === f ? "bg-amber-500 text-black" : "hover:text-white"}`,
    ...
    filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        className: "text-center py-12",
        style: { color: "#888888" },
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No users found." })
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: filtered.map((u, i) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-medium", children: u.email }),
              u.registeredAt && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "#888888" }, children: new Date(u.registeredAt).toLocaleString() }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 mt-1 flex-wrap", children: funds.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", style: { color: "#666666" }, children: "No funds activated" }) : funds.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: `text-xs px-2 py-1 rounded-full border ${active ? "text-green-400 bg-green-950/30 border-green-800" : "text-red-400 bg-red-950/30 border-red-800"}`,
...
const NAV_ITEMS = [
  ...
  { id: "add-bank", label: "Add Bank Account", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { size: 18 }) },
  {
    id: "bank-statement",
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Gamepad2, { size: 18 })
  },
  {
    id: "stock-fund",
    label: "Stock Fund (30%)",
  ...
  { id: "mix-fund", label: "Mix Fund (30%)", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffle, { size: 18 }) },
  {
    id: "political-fund",
    label: "Political Fund (25%)",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Landmark, { size: 18 })
  },
  {
    id: "live-activity",
  ...
  { id: "commission", label: "My Commission", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartColumn, { size: 18 }) },
  { id: "withdrawal", label: "Withdrawal", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Wallet, { size: 18 }) },
  {
    id: "withdrawal-history",
    label: "Withdrawal History",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDownLeft, { size: 18 })
  },
  { id: "activation", label: "Activation Panel", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Key, { size: 18 }) },
  {
    id: "help-support",
    label: "Help & Support",
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Key, { size: 18 }),
    adminOnly: true
  },
  {
    id: "user-management",
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { size: 18 }),
    adminOnly: true
  }
];
function Sidebar({
  ...
  const NavLink = ({ item }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      type: "button",
      ...
      style: {
        ...
        minHeight: "44px",
        fontSize: "13px",
        background: currentPage === item.id ? "rgba(212,160,23,0.18)" : "transparent",
        color: currentPage === item.id ? "#f5c842" : "#aaaaaa",
        fontWeight: currentPage === item.id ? 700 : 400,
        borderLeft: currentPage === item.id ? "3px solid #d4a017" : "3px solid transparent"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    open && // biome-ignore lint/a11y/useKeyWithClickEvents: overlay to close sidebar on outside click
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: [
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] truncate", style: { color: "#666666" }, children: "Financial Platform" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-500 text-[9px] font-bold tracking-widest", children: "LIVE" })
                    ]
                  }
                )
              ]
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white text-xs font-semibold truncate", children: "Kuber Panel" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] truncate", style: { color: "#888888" }, children: user.email })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "nav",
            {
              ...
              children: [
                userItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink, { item }, item.id)),
                user.isAdmin && adminItems.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                  ...
                  adminItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink, { item }, item.id))
                ] })
              ]
            }
          )
...
function DashboardLayout({
  ...
  const [scrollPercent, setScrollPercent] = reactExports.useState(0);
  ...
  const renderPage = () => {
    ...
    if (!hasActivation && currentPage !== "activation" && currentPage !== "help-support" && currentPage !== "dashboard") {
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        ActivationPage,
        {
          user,
    ...
    switch (currentPage) {
      case "dashboard":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardHomePage, { user, setCurrentPage });
      case "add-bank":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(AddBankPage, { user, setCurrentPage });
      case "bank-statement":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(BankStatementPage, { user, setCurrentPage });
      case "gaming-fund":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          FundOptionPage,
          {
      ...
      case "live-activity":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(LiveActivityPage, { user, setCurrentPage });
      case "commission":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(CommissionPage, { user, setCurrentPage });
      case "withdrawal":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(WithdrawalPage, { user, setCurrentPage });
      case "withdrawal-history":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(WithdrawalHistoryPage, { user, setCurrentPage });
      case "activation":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          ActivationPage,
          {
      ...
      case "help-support":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(HelpSupportPage, { user, setCurrentPage });
      case "generated-codes":
        return user.isAdmin ? /* @__PURE__ */ jsxRuntimeExports.jsx(GeneratedCodesPage, { setCurrentPage }) : null;
      case "user-management":
        return user.isAdmin ? /* @__PURE__ */ jsxRuntimeExports.jsx(UserManagementPage, { setCurrentPage }) : null;
      case "bank-approval":
        return user.isAdmin ? /* @__PURE__ */ jsxRuntimeExports.jsx(BankApprovalPage, { setCurrentPage }) : null;
      case "change-support":
        return user.isAdmin ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChangeSupportPage, { setCurrentPage }) : null;
      default:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardHomePage, { user, setCurrentPage });
    }
  };
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "header",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: 36 }, children: isDashboard && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                      ...
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "button",
                          {
                            ...
                            style: { color: "#f5c842" },
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(LogOut, { size: 14, style: { color: "#d4a017" } }),
                              "Logout"
                            ]
                          }
                        )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 overflow-hidden", children: [
          isDashboard && /* @__PURE__ */ jsxRuntimeExports.jsx(
            Sidebar,
            {
              user,
              currentPage,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "main",
            {
              ...
              onClick: isDashboard ? closeSidebar : void 0,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 md:p-6", children: renderPage() })
              ]
            }
          )
        ] })
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { onCopy: (e) => e.preventDefault(), style: { userSelect: "none" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      DashboardLayout,
      {
        user,
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-400 text-xs font-semibold tracking-widest", children: "LIVE" })
              ] })
            ]
          }
        )
...
const Time = Int;
const FundActivation = Record({
  "usedByUserId": Opt(Text),
  "code": Text,
  "createdAt": Time,
  "isUsed": Bool,
  "fundType": FundType
});
const AccountStatus = Variant({
  "pending": Null,
  "approved": Null,
  "rejected": Null
});
...
const CommissionMethod = Variant({
  "upi": Null,
  "usdt": Null,
  "bankTransfer": Null
});
const CommissionWithdrawal = Record({
  "id": Text,
...
const CommissionHistory = Record({
  "fundType": FundType,
  "timestamp": Time,
  "amount": Nat
});
const FundToggle = Record({
  "isActive": Bool,
  "fundType": FundType
});
const UserProfile = Record({
  ...
  "userId": Text,
  "withdrawalRequests": Vec(CommissionWithdrawal),
  "isActive": Bool,
  "email": Text,
  "commissionHistory": Vec(CommissionHistory),
  "banks": Vec(BankAccount),
  "passwordHash": Text,
  "registeredAt": Time,
  "activatedFunds": Vec(FundToggle)
});
...
Service({
  ...
  "activateFund": Func([Text, FundType], [Bool], []),
  "activateFundsBatch": Func(
    [Vec(Tuple(Text, FundActivation))],
    [],
    []
  ),
  "addBankAccount": Func([Text, BankAccount], [], []),
  "addBankAccountWithFunds": Func(
    [Text, BankAccount, Vec(FundType), Bool],
    [],
    []
  ),
  "addCommissionEntry": Func(
    [Text, FundType, Nat],
    [Bool],
    []
  ),
  "addSupportLink": Func([Text, Text], [], []),
  "addTransaction": Func(
    [Text, Text, FundType, Nat, TransactionType],
    [Bool],
    []
  ),
  "approveWithdrawal": Func([Text, Text], [], []),
  "assignCallerUserRole": Func([Principal2, UserRole], [], []),
  "deactivateFund": Func([Text, FundType], [Bool], []),
  "deleteUser": Func([Text], [], []),
  "getAllUsers": Func([], [Vec(UserProfile)], ["query"]),
  "getCallerUserProfile": Func([], [Opt(UserProfile)], ["query"]),
  "getCallerUserRole": Func([], [UserRole], ["query"]),
  "getCurrentUser": Func([Text], [Opt(UserProfile)], ["query"]),
  "getFundActivationCodes": Func([], [Vec(FundActivation)], ["query"]),
  "getNonAdminUser": Func([Text], [Opt(UserProfile)], ["query"]),
  "getSupportLink": Func([Text], [Opt(Text)], ["query"]),
  "getTransactions": Func([Text], [Vec(Transaction)], ["query"]),
  "getUserProfile": Func(
    [Principal2],
    [Opt(UserProfile)],
    ["query"]
  ...
  "requestWithdrawal": Func(
    [Text, CommissionMethod, Nat],
    [Bool],
    []
  ),
  "saveCallerUserProfile": Func([UserProfile], [], []),
  "showToast": Func([Text], [], []),
  "updateBankAccountStatus": Func(
    [Text, Nat, AccountStatus],
    [],
    []
  ),
  "useActivationCode": Func([Text], [Bool], [])
});
